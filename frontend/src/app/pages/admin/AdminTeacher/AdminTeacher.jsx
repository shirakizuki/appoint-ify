...
const AdminTeacher = ({departmentID}) => {
  ...
  const loadTeacher = async (departmentID) => {
    ...
    if (response.data.status) {
      ...
      console.log('Failed to load teachers:', response.data);
    }
  }
  ...
  const handleTeacherClick = (teacher) => {
    // Set selected teacher when button is clicked
    setSelectedTeacher(teacher);
  }

  // Handles loading of teachers when department name changes
  useEffect(() => {
    // Loads teacher list based on department name
      ...
      <div className="section-left">
        ...
        <div className="left-cont">
          ...
          <div className="teacher-cont">
            {/* Teacher container that contains the list of teachers */}
