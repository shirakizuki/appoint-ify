...
const Schedule = ({ teacherID }) => {
    ...
    const [weeklyMessage, setWeeklyMessage] = useState(''); // State to store weekly schedule message
    ...
    const handleSaveWeeklyEdit = async () => {
        ...
        try {
            const token = sessionStorage.getItem('token')
            const response = await axios.put(`${url}/updateweeklyschedule`, {
                teacherID,
